		...
		<div className="chat-input">
			...
			>
				...
				<textarea
					...
					name="input"
					autoComplete="off"
					placeholder="Ask the agent to map arguments, reveal tensions, or draft questions"
					value={inputValue}
				...
				<span className="chat-actions">
					...
					<button
						...
						aria-label={isGenerating && inputValue === '' ? 'Stop generation' : 'Send message'}
					>
						{isGenerating && inputValue === '' ? 'Stop' : 'Send'}
					</button>
				</span>
			</form>
		</div>

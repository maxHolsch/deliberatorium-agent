...
import { CreateConceptNodeActionUtil } from '../actions/CreateConceptNodeActionUtil'
import { CreateRelationshipEdgeActionUtil } from '../actions/CreateRelationshipEdgeActionUtil'
...
import { ReadingContextPartUtil } from '../parts/ReadingContextPartUtil'
...
export const AGENT_MODE_DEFINITIONS = [
	...
	},
	{
		...
		actions: [
			...
			CreateConceptNodeActionUtil.type,
			CreateRelationshipEdgeActionUtil.type,

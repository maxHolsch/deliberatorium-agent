...
${flagged(
	...
	- In Deliberatorium mode, make AI-authored first-pass concept nodes yellow and grounded in uploaded reading context.
...
${flagged(
	...
	- In Deliberatorium mode, use edge labels to capture support, contradiction, tension, or extension explicitly.

...
// Create Concept Node Action
export const CreateConceptNodeAction = z
	.object({
		_type: z.literal('create-concept-node'),
		intent: z.string(),
	...
	.meta({
		...
		description:
			'Create an AI-authored yellow concept node that seeds a reading map with a claim, concept, or question.',
	})

export type CreateConceptNodeAction = z.infer<typeof CreateConceptNodeAction>

// Create Relationship Edge Action
export const CreateRelationshipEdgeAction = z
	.object({
		_type: z.literal('create-relationship-edge'),
		intent: z.string(),
		shapeId: SimpleShapeIdSchema.optional(),
		fromShapeId: SimpleShapeIdSchema,
		toShapeId: SimpleShapeIdSchema,
	...
	.meta({
		...
		description:
			'Create an AI-authored yellow relationship edge between two concept nodes with an optional relationship label.',
	})

export type CreateRelationshipEdgeAction = z.infer<typeof CreateRelationshipEdgeAction>
